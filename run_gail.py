...
parser.add_argument('--pol_ent_beta', type=float, default=0.001,
...
parser.add_argument('--rl_type', type=str,
                    choices=['trpo', 'ppo_clip', 'ppo_kl'], default='ppo_clip')
...
parser.add_argument('--tr', action='store_true', default=False, help='Task Reward')

args = parser.parse_args()
if args.env_name == "ThrowerGoal-v2" or "Thrower-v2": args.discrim_step = 300
saving_epi = 1
...
while args.max_epis > total_epi:
    ...
    with measure('train'):
        ...
        agent_traj = task_oriented_reward(agent_traj, discrim) if args.tr else ef.compute_pseudo_rews(agent_traj, discrim) # TRGAILorGAIL
